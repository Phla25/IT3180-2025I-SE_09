...
public class OfficerController {
    ...
    public String showOfficerDashboard(Model model, Authentication auth) {
        ...
        // Cần đảm bảo logic thống kê trên dashboard-officer.html khớp với logic
        // Service.
        ...
        Long suCoTrungBinh = suCoService.getSuCoTheoMucDo(PriorityLevel.binh_thuong); // Dùng binh_thuong thay vì
                                                                                      // trung_binh
    ...
    public String showOfficerApartmentDetails(@RequestParam("maTaiSan") Integer maTaiSan, Model model,
            Authentication auth) {
    ...
    public ResponseEntity<byte[]> exportApartments() {
        try {
            ...
            headers.setContentDispositionFormData("attachment",
                    "BaoCao_CanHo_CQCN_" + System.currentTimeMillis() + ".xlsx");
    ...
    public ResponseEntity<byte[]> exportResidents() {
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_OCTET_STREAM);
            headers.setContentDispositionFormData("attachment",
                    "BaoCao_CuDan_CQCN_" + System.currentTimeMillis() + ".xlsx");
    ...
    public ResponseEntity<byte[]> exportApartmentsPdf() {
        try {
            ...
            headers.setContentDispositionFormData("attachment",
                    "BaoCao_CanHo_CQCN_" + System.currentTimeMillis() + ".pdf");
    ...
    public ResponseEntity<byte[]> exportResidentsPdf() {
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_PDF);
            headers.setContentDispositionFormData("attachment",
                    "BaoCao_CuDan_CQCN_" + System.currentTimeMillis() + ".pdf");
